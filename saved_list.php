    ...
    <div class="button-group mt-4 mb-3">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><button class="dropdown-item" onclick="" type="button">Add Tag</button></li>
                <li><button class="dropdown-item" onclick="" type="button">Remove Tag</button></li>
                ...
                <li><button class="dropdown-item" onclick="#" type="button">Merge Duplicates</button></li>
                <li><button class="dropdown-item" onclick="#" type="button">Send Broadcast</button></li>
            </ul>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                // Basic Select2 initialization first
                $('#tags').select2({
        ...
        // Auto-save tags when selection changes
        $('#tags').on('change', function() {
            saveTags();
        });
